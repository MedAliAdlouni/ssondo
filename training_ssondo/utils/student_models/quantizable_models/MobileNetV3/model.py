...
class QuantizableMN(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(
            "Number of trainable parameters - QuantizableMobileNetV3: ",
            self.n_parameters,
        )  # nopep8
...
def _quantizable_mobilenet_v3(
    ...
    **kwargs: Any,
    ...
    if pretrained_path is not None:
        ...
        state_dict = {
            k.replace("student_model.model.", ""): v
            for k, v in checkpoint["state_dict"].items()  # nopep8
...
def quantizable_mobilenet_v3(
    ...
    **kwargs: Any,
    ...
    return _quantizable_mobilenet_v3(
        inverted_residual_setting, last_channel, pretrained_path, **kwargs
    )
