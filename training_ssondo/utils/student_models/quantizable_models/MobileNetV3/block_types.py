...
from training_ssondo.utils.student_models.MobileNetV3.model import InvertedResidualConfig
...
class QuantizableConcurrentSEBlock(nn.Module):
  ...
  def __init__(self,
    ...
    for d in se_cnf["se_dims"]:
      ...
      self.conc_se_layers.append(QuantizableSqueezeExcitation(input_dim, squeeze_dim, d))  # nopep8
