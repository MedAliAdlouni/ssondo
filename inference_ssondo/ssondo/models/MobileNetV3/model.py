...
def _mobilenet_v3_conf(
  ...
  inverted_residual_setting = [
      ...
      bneck_conf(112, 5, 672, 160 // reduce_divider, True, activation, strides[3], dilation),  # C4 # nopep8
      bneck_conf(160 // reduce_divider, 5, 960 // reduce_divider, 160 // reduce_divider, True, activation, 1, dilation),  # nopep8
      bneck_conf(160 // reduce_divider, 5, 960 // reduce_divider, 160 // reduce_divider, True, activation, 1, dilation),  # nopep8
  ]
...
def mobilenet_v3(
  ...
  return _mobilenet_v3(inverted_residual_setting,
                       last_channel,
                       **kwargs)
...
def get_model(
  ...
  pretrained_name : str, optional
    Ignored at inference time (default is None).
