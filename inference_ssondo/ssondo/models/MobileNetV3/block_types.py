...
class ConcurrentSEBlock(nn.Module):
  ...
  def __init__(self,
    ...
    for d in se_cnf["se_dims"]:
      ...
      self.conc_se_layers.append(SqueezeExcitation(input_dim, squeeze_dim, d))  # nopep8
...
class InvertedResidualConfig:
  ...
  def __init__(
    ...
    self.kernel = kernel
    self.expanded_channels = self.adjust_channels(expanded_channels, width_mult)  # nopep8
